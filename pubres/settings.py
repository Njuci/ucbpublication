"""
Django settings for pubres project.
...
SECRET_KEY = 'django-insecure-#kxfyonss)uo=7_jin5z_1fhmru2dn1txs!lzf7xwk5ulhv9ts'
...
WSGI_APPLICATION = 'pubres.wsgi.application'
